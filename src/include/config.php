...
define('WPN_MESSAGE_ERROR_LEVEL', [
    'normal' => [
        'errorno' => 0,
        'level' => 'info',
        // 'icon' => "https://raw.githubusercontent.com/Peuuuur-Noel/unraid-web-push-notification/master/plugin/notify-normal.png",
    ...
    'warning' => [
        'errorno' => 1,
        'level' => 'warning',
        // 'icon' => "https://raw.githubusercontent.com/Peuuuur-Noel/unraid-web-push-notification/master/plugin/notify-warning.png",
    ...
    'alert' => [
        'errorno' => 2,
        'level' => 'error',
        // 'icon' => "https://raw.githubusercontent.com/Peuuuur-Noel/unraid-web-push-notification/master/plugin/notify-alert.png",
